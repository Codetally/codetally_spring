...
public class UserController {
    @Autowired
    private codetally.service.UserService UserService;

    @Autowired
    private codetally.service.SecurityService SecurityService;

    @Autowired
    private codetally.validator.UserValidator UserValidator;

    @Autowired
    private codetally.validator.UserprofileValidator UserprofileValidator;
